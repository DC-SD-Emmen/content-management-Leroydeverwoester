...
<body>
    ...
    <div class="container">
        ...
        <h1>Welcome Big Boy <?php echo $_SESSION['username']; ?></h1>
        ...
        <p>Fun Fact: <?php echo $randomFact; ?></p> <br>
            <a class="logout" href="user.php?action=logout" onclick="return confirm('Are you sure you want to log out?');">Log out</a>
            <button class ="logout" onclick="window.location.href='change.php'">Change Account Details</button>
    </div>
